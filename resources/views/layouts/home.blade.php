    ...
    <div id="jstop" class="header-2">
        <div class="header">
            ...
            <div class="nav-list">
                ...
                <a class="fl " baidu_alog="pc_index_top_tab&amp;click&amp;pc_index_top_tab_sell_c" href="{{url('/home/sell')}}" data-gzlog="tracking_type=click&amp;eventid=0010050000000009">我要卖车</a>
