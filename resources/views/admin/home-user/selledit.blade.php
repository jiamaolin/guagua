...
{{--                {{method_field('put')}}--}}
                ...
                <tr>
                    <th>车型：</th>
                    <td>
                        <input type="text" name="cars_kuanShi" value="{{$sell->car_type}}" readonly="reload">
                    </td>
                </tr>
                <tr>
                    <th>款式：</th>
                 ...
                 <tr>
                    <th>排放：</th>
                    <td>
                        <input type="text" name="cars_paiLiang" value="{{$sell->car_paiFang}}" readonly="reload">
                    </td>
                </tr>
                <tr>
                    <th>变速箱：</th>
                    <td>
                        <input type="text" name="cars_bianSu" value="{{$sell->car_biansu}}" readonly="reload">
                    </td>
                </tr>
                <tr>
                    <th>图片：</th>
                    <td>
                        ...
                        <input type="hidden" name="cars_img" value="{{ $sell->cars_img }}">
                    </td>
                </tr>
                <tr>
                    <th>价格：</th>
                ...
                <tr>
                    <th>状态：</th>
                    <td>
                        <input type="radio" name="cars_status" value="1" >审核通过
                        <input type="radio" name="cars_status" value="2" >禁止发布
